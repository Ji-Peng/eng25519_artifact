...
#define CLOCKS(LABEL, FUNCTION, NUMBER) \
    CLOCKS_RANDOM(while (0), LABEL, FUNCTION, NUMBER)
...
#define oper_second_print(RANDOM, LABEL, FUNCTION, NUMBER)           \
    do                                                               \
    {                                                                \
        printf("%-25s : ", #LABEL);                                  \
        RANDOM;                                                      \
        ...
        {                                                            \
            ...
            FUNCTION;                                                \
            end_c = cycles_now();                                    \
            printf("%6lu cc, ", (unsigned long)((end_c - start_c))); \
        }                                                            \
        printf("\n");                                                \
    } while (0)
