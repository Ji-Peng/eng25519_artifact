...
start_time="2023-06-07 19:40:00"
start_time_p256=
end_time_p256=
start_time_x25519=
end_time_x25519=
...
server_backup_log_file() {
    ...
    printf -v filename_P256 "throughput/$current_time_path/P256_dotc_%02d.txt" 7
    printf -v filename_X25519 "throughput/$current_time_path/X25519_dotc_%02d.txt" 7
    printf -v filename_X25519_AllOpenSSL "throughput/$current_time_path/X25519_AllOpenSSL_dotc_%02d.txt" 7
    > ${filename_P256}
    > ${filename_X25519}
    ...
    do
        ...
        printf -v filename_X25519_ENG25519_COLD "throughput/$current_time_path/X25519_ENG25519_cold_dotc_%02d.txt" $i
        > ${filename_X25519_ENG25519_COLD}
    done
}
...
print_timeline() {
    ...
    end_time_p256=$(time_add_seconds "${start_time_p256}" "$long_time")
    output+="The end time of P256 benchmark: ${end_time_p256}\n\n"

    start_time_x25519=$(time_add_seconds "${end_time_p256}" "$internel")
    output+="The start time of X25519 benchmark: ${start_time_x25519}\n"
    end_time_x25519=$(time_add_seconds "${start_time_x25519}" "$long_time")
    output+="The end time of X25519 benchmark: ${end_time_x25519}\n\n"

    start_time_x25519_AllOpenSSL=$(time_add_seconds "${end_time_x25519}" "$internel")
    output+="The start time of X25519-AllOpenSSL benchmark: ${start_time_x25519_AllOpenSSL}\n"
    end_time_x25519_AllOpenSSL=$(time_add_seconds "${start_time_x25519_AllOpenSSL}" "${long_time}")
    output+="The end time of X25519-AllOpenSSL benchmark: ${end_time_x25519_AllOpenSSL}\n\n"

    start_time_x25519_eng25519=$(time_add_seconds "${end_time_x25519_AllOpenSSL}" "$internel")
    output+="The start time of X25519-ENG25519 benchmark: ${start_time_x25519_eng25519}\n"
    end_time_x25519_eng25519=$(time_add_seconds "${start_time_x25519_eng25519}" "$((10*${long_time}))")
    output+="The end time of X25519-ENG25519 benchmark: ${end_time_x25519_eng25519}\n\n"

    start_time_x25519_eng25519_cold=$(time_add_seconds "${end_time_x25519_eng25519}" "$internel")
    output+="The start time of X25519-ENG25519 benchmark: ${start_time_x25519_eng25519_cold}\n"
    end_time_x25519_eng25519_cold=$(time_add_seconds "${start_time_x25519_eng25519_cold}" "$((10*${long_time}))")
    output+="The end time of X25519-ENG25519 benchmark: ${end_time_x25519_eng25519_cold}\n\n"
