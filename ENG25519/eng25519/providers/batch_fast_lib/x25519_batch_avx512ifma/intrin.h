...
#define VSHUF32(X, Y) _mm512_shuffle_epi32(X, Y)
...
#define VMXOR(SRC, M, SRC1, SRC2) _mm512_mask_xor_epi64(SRC, M, SRC1, SRC2)
 ...
 * 
 * X = [X0 X1 X2 X3 X4 X5 X6 X7], W = 0xEB = 1110 1011
 * result = [X3 X2 X2 X3 X7 X6 X6 X7]
 */
...
#define VSTORE(ADDR, X) _mm512_store_epi64(ADDR, X)
